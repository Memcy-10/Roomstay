...
const AdminUsers = () => {
  ...
  const visibleUsers = users.filter((user) =>
    `${user.firstName} ${user.lastName} ${user.email} ${user.documentNumber || ''} ${user.phone || ''}`
